...
class ExperimentState:
    ...
    def __post_init__(self) -> None:
        ...
        # Populated by _load_holder_init() and _state_from_dict().
    ...
    def new(
        ...
        Holder slots are seeded from holder_state.json (if provided);
        otherwise slots default to EMPTY.
...
def _state_from_dict(data: dict) -> ExperimentState:
    ...
    # Rebuild the runtime reverse index from persisted holder slots
